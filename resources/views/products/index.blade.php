					...
					<tr class="border-b bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
						...
						<td class="px-6 py-4">
							<div class="flex gap-5">
								...
								<div class="inline-flex">
									<a
										class="w-full items-center justify-center rounded border border-transparent bg-red-500 px-3 py-2 text-sm font-medium leading-5 text-white shadow-sm transition duration-150 ease-in-out hover:bg-red-600 focus:outline-none focus-visible:ring-2"
